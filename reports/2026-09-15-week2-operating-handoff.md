...
|---|---|---|---|---|
| PREREG-099 host driver v2 | `results/run_119_local.pid` in `/home/erich/projects/.nfl2-worktrees/prereg099-supply12800-20260916` (228767 since 2026-09-17 00:28Z) | bank 990 running: run `119b990r1-20260917T002831Z`, 72 slates, 10 workers, ≈ 10.7 h per slate (amendment 3: the rung is 12,560 candidates — boom is bounded by the 10,000-world bank); ≈ 3.2 days; STOP it Saturday 17:00 CT, resume after Sunday; read expected Monday | `results/run_119_local.log`, `results/run_119_local_tasks.log`, `results/119_local/<run id>/tNN.log`; run ids in `results/run_119_local_runs.log` | rerun `setsid nohup scripts/run_119_local_v2.sh 10 > results/run_119_local.log 2>&1 < /dev/null &` from that worktree — attach-aware (skips slates already in the bucket) |
