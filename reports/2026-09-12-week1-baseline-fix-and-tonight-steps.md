...
| live shadow books (corrected centering, flag-gated arms on `lab/live-center-production-20260912` @ `e85c845`) | `<scratch>/nfl2-coldstart-probe/results/live/2026-w01/`: direct-tail `20260912T181354328816Z-e85c845`, DT-union `…181838197810Z-e85c845`, spread-4 `…182423139959Z-e85c845`, no-bring-back sleeve (building) | frozen shadow books for Monday settlement (`settle_live.py`); never enter the paid book (prereg rules) |
