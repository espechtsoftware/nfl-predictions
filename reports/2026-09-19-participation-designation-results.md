...
[Protocol](2026-09-19-participation-designation-protocol.md), [full numerical result](reviews/evidence/2026-09-19-participation-designation-result.json), [fresh-bank identities](reviews/evidence/2026-09-19-participation-designation-audit.json), [original participation report](2026-09-19-participation-transfer-results.md). The portable replay reproduces all numbers and delivered orders exactly. [Published bundle identity](reviews/evidence/2026-09-19-participation-designation-publication.json). The workstation independently replayed every numerical result, selected order, delivered block and exposure exactly (lab handoff commit `ca6022b`, fetched at 13:27 UTC). It agrees that fresh worlds and masks provide a real simulation replication, with model-conditional interpretation throughout.

The narrowed rule is not selected because one block looks better after inspection. Historical calibration and the prior full-rule historical trial provide evidence separate from this current-slate simulation; fresh random seeds alone cannot establish which participation model is correct. The observed all-active losses and contest-block losses remain material costs.
