...
PATH = BASE / 'd6400-reselection-portable-v1.tar.gz'
BUCKET = 'nfl-2-506823-lab'
KEY = 'research/d6400-reselection-20260919/portable-v1.tar.gz'
EXPECTED = 'b3bcbfc140d5ab889ff77f469f968e2fb88a5816e2884abbfb57862499c48b52'


def main():
    raw = PATH.read_bytes()
    assert hashlib.sha256(raw).hexdigest() == EXPECTED
    out = BASE / 'd6400-reselection-publication'
