...
FROZEN_BOOKS = '53bba4df0a9a5394323ea8bbf39273b11503a77e50d1c854f1e0e7a9e3e042eb'
OUT = ROOT / 'exposure-cap-audit'
...
def main():
    ...
    assert sha(ROOT / 'exposure-cap-proposals/frozen-books.json') == FROZEN_BOOKS
    ...
    with data.outcome_firewall(2026):
        ...
        banks = {'I': incumbent(24260919), 'H': hsim(25260919)}
    identities = {}
    for name, bank in banks.items():
        ...
        identities[name] = dict(path=str(p), sha256=sha(p), seed={'I': 24260919, 'H': 25260919}[name])
