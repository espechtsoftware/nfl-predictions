...
UPSTREAM_EXECUTION_LEDGER_SHA=6794f8e608497613aec2f06f2bd13e57cf08b945d7ac20e2d4d00eb1ee3d5ea5
IMAGE=${1:-}
CODE_SHA=${2:-}
...
[ "$(sha256sum "$UPSTREAM/executions.txt" | awk '{print $1}')" = "$UPSTREAM_EXECUTION_LEDGER_SHA" ] || {
  echo "ERROR: strict upstream ATLAS execution ledger differs" >&2; exit 2; }
