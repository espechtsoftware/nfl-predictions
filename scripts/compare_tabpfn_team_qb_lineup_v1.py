#!/usr/bin/env python3
"""Compare the PIT-clean team-QB same-image exact-80 evaluation books."""
...
from nfl_dfs.research import tabpfn_team_qb_lineup_v1 as experiment  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--role-selected", choices=("true", "false"),
                        required=True)
    ...
    report = {
        ...
        "mode": "pit-clean-tabpfn-team-qb-v1",
        **audits,
