...
PATH = BASE / 'd6400-exposure-cap-portable-v1.tar.gz'
BUCKET = 'nfl-2-506823-lab'
KEY = 'research/d6400-exposure-cap-20260919/portable-v1.tar.gz'
EXPECTED = '6ed7644387c1a0854277b159fdc96dc9417377b88feecb9b8812ca86a612fa89'


def main():
    raw = PATH.read_bytes()
    assert hashlib.sha256(raw).hexdigest() == EXPECTED
    out = BASE / 'd6400-exposure-cap-publication'
