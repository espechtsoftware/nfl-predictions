...
PATH = BASE / 'd6400-first-entry-tail-portable-v1.tar.gz'
BUCKET = 'nfl-2-506823-lab'
KEY = 'research/d6400-first-entry-tail-20260919/portable-v1.tar.gz'
EXPECTED = '29527c9e2b50b13f48b7afe494026d5a62e94192e01d5a5f2bb22d286af12e82'


def main():
    raw = PATH.read_bytes()
    assert hashlib.sha256(raw).hexdigest() == EXPECTED
    out = BASE / 'd6400-first-entry-tail-publication'
