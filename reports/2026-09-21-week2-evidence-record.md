...
filled once on 2026-09-21 and are likewise closed. Still open: fixed lineup totals, fixed-book maxima and pool-level
simulated-vs-realized exceedance, which need the book's simulated distribution; and the P220 / P230 / winner-proxy
ordering reads, which are the labs'.
