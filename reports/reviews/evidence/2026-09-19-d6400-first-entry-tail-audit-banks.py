...
FROZEN_BOOKS = 'b65abc84096a60efd4e0652bc3b76dfe97978151cb9847a777160bcc8d74dcc6'
OUT = ROOT / 'first-entry-tail-audit'
...
def main():
    ...
    assert sha(ROOT / 'first-entry-tail-proposals/frozen-books.json') == FROZEN_BOOKS
    ...
    with data.outcome_firewall(2026):
        ...
        banks = {'I': incumbent(22260919), 'H': hsim(23260919)}
    identities = {}
    for name, bank in banks.items():
        ...
        identities[name] = dict(path=str(p), sha256=sha(p), seed={'I': 22260919, 'H': 23260919}[name])
