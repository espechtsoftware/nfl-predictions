...
## Independent replay and subsequent objective comparison

The [portable publication](reviews/evidence/2026-09-19-d6400-reselection-publication.json) binds `gs://nfl-2-506823-lab/research/d6400-reselection-20260919/portable-v1.tar.gz`, generation1789854774485122, bytes19135033, SHA `b3bcbfc140d5ab889ff77f469f968e2fb88a5816e2884abbfb57862499c48b52`. Downloaded bytes match exactly; portable reader `d541986e` reproduces every result field except reader SHA/elapsed seconds. The bundle includes the exact [CSV permutation proof](reviews/evidence/2026-09-19-d6400-promotion-proof.json): current book `86147c51…` to candidate `4f22dfbf…`, every player cell and row byte preserved. This is research evidence, not an uploader/sheet rehearsal. Replay command and manifest identities are in shared handoff `da3e2da`.

The subsequent [direct first-entry tail-objective comparison](2026-09-19-d6400-first-entry-tail-results.md) selects rank2 under both P220 and proxy rules. It improves first-entry mean/proxy against current order, but does not establish superiority over the mean rule. On that fresh audit, the mean rule's P220 gain is +0.075pp with an interval crossing zero, versus +0.165pp in this original audit; both are retained. Mean/proxy benefits persist, while the small tail magnitude remains uncertain.

**Independent production cross-read received at22:06Z:** shared `fd11e54` reports35,819fields with zero differences in the full-reselection replay (excluding only reader SHA/seconds), including all ten stresses, plus exact byte-level rank5 CSV permutation. The separate frontier replay passed4,496fields with zero differences. These establish numerical reproducibility, not NFL efficacy. Production has a new final-book promotion consumer; its source has been requested for independent review, especially risk classification of newly introduced replacement players.
