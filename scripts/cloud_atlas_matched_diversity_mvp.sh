...
REPAIR_VALIDATION_SHA=TO_BE_FROZEN_AFTER_STRICT_REPAIR_HARVEST
REPAIR_EXECUTION_SHA=TO_BE_FROZEN_AFTER_STRICT_REPAIR_HARVEST
REPAIR_COMPLETION_SHA=TO_BE_FROZEN_AFTER_STRICT_REPAIR_HARVEST
IMAGE=${1:-}
CODE_SHA=${2:-}
