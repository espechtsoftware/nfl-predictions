#!/usr/bin/env python3
"""Compare the PIT-clean active-label same-image exact-80 books."""
...
from nfl_dfs.research import tabpfn_active_label_lineup_v2 as experiment  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--allocation", choices=("multinomial", "dirichlet"), required=True)
    ...
    report = {
        ...
        "mode": "pit-clean-tabpfn-active-label-v2",
        **audits,
