...
def main():
    p = ROOT / 'first-entry-tail-proposals/frozen-books.json'
    assert sha(p) == 'b65abc84096a60efd4e0652bc3b76dfe97978151cb9847a777160bcc8d74dcc6'
    ...
    control, promoted = frozen['books']['control'], frozen['books']['proxy']
    ...
    result = dict(kind='research_order_permutation_proof', operational_publish=False,
        ...
        promoted_from_rank=frozen['choices']['proxy']['promoted_from_rank'],
