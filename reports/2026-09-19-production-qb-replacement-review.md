...
## 21:14 UTC independent real D6400 rehearsal

The complete archive has now arrived from production. All11object identities verify, and the original K97 book and every stored incumbent candidate mean reproduce exactly from the 6,399-candidate pool. The independent [scratch runner](reviews/evidence/2026-09-19-d6400-v43-rehearsal.py), frozen at `051b9c5c`, executes the exact cleared tools with real read-only provider queries, recording query inputs and restricting frame reads to14explicit input columns. No `actual` or candidate audit-summary column is decoded.

With the newer DK capture, v4.3 successfully replaces **46 lineups**, validates all97final rows and retains3,315eligible unused alternatives. Zay Flowers appears in45of the removed rows; the combined reason counts also include O'Connell, Pittman and Bagent, with overlaps. Replacements include delivered positions29and30, so this exercises the first30 boundary on real input. The larger removal count is explained by Flowers' new OUT status; it is not a change to the exclusion policy or evidence of a scoring lift.

The [rehearsal receipt](reviews/evidence/2026-09-19-d6400-v43-rehearsal.json) and [replacement details](reviews/evidence/2026-09-19-d6400-v43-replacement.json) bind the exact sources and output. Final book SHA `86147c51b94b7abb960b88fb38396c457efc96adea66253db392506f78cfdb8b`; final flags SHA `a12d9867f0babc7bfd9cfd41f3653df007a8b10ff3277ee10e270b1eb543d9a1`. This is an independently marked research rehearsal, not a change to an ENTER pointer or upload file. Operational host installation still belongs to production after D12800 completes.
