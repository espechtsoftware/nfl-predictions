"""Provider-bound research reselection from ordinary live_week artifacts (v2).
...
def execute(run,status_dir,map_path,out,confirmed=None,as_of=None):
    ...
    result=dict(schema='participation-candidate-reselection/v2',disposition='RESEARCH_ONLY_NOT_ADOPTED',
