"""Capture and assemble the v6 runtime IAM policy capture.

Re-captures every component fresh AFTER the v4->v6 IAM condition move —
...
OUT_DIR = Path(
    ...
    "20260822-foundry-production-v6/governance-live-v6"
)
