...
Usage: python fill_dk_entries.py DKEntries.csv [--enter-dir DIR] [--out-dir DIR] [--frame frame.parquet]"""
...
def main():
    ...
    ap.add_argument("--frame", default=None, help="frame.parquet for 'Name (ID)' cells; bare IDs if absent"); a = ap.parse_args()
