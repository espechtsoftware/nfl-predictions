...
FROZEN_BOOKS = 'cd604b8fc0c90c27043bd04d2f324acfbe124987d467a480acde36210a657143'
OUT = ROOT / 'fresh-audit'
...
def main():
    ...
    assert sha(ROOT / 'frontier-proposals/frozen-books.json') == FROZEN_BOOKS
    ...
    with data.outcome_firewall(2026):
        ...
        banks = {'I': incumbent(18260919), 'H': hsim(19260919)}
    identities = {}
    for name, bank in banks.items():
        ...
        identities[name] = dict(path=str(p), sha256=sha(p), seed={'I': 18260919, 'H': 19260919}[name])
