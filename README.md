...
| `ingest_cfb` | Not yet scheduled — opt-in via `INGEST_CFB_ENABLED` (see *Known gaps*: CFB collection scaffold) | Collection-only for the 2026 season once real CFB slates exist (late Aug onward); no adoption decision until then |
