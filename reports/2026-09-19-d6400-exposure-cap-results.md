...
Published `gs://nfl-2-506823-lab/research/d6400-exposure-cap-20260919/portable-v1.tar.gz`, generation `1789857393455730`, 19,078,912 bytes, SHA256 `6ed7644387c1a0854277b159fdc96dc9417377b88feecb9b8812ca86a612fa89`. Manifest SHA256 `00b77f510755ac39fb1b97e4f0e8f8d2668e6e75240b2a478dfc67c279292600`. Create-once upload and downloaded bytes match exactly; [publication receipt](reviews/evidence/2026-09-19-d6400-exposure-cap-publication.json).

Use [replay reader](reviews/evidence/2026-09-19-d6400-exposure-cap-replay-v2.py), SHA256 `d168bee21036b88afeb26393b87784d2dd3ee514702f2367915baf20c451b93a`, with `--root EXTRACTED_DIRECTORY --output NEW_RESULT.json` and its existing neighboring helper scripts from research commit `78e91390` or later. Run with one numerical thread. It needs no BigQuery or live provider calls and reads only `id, display_name` from the copied frame. Verify manifest hashes before use. The local portable replay matches **26,758 scalar fields exactly** after excluding only reader SHA and elapsed seconds; [comparison receipt](reviews/evidence/2026-09-19-d6400-exposure-cap-replay-parity.json). This is a numerical repeat, not independent confirmation of the predictive model or a reconstruction of proposal generation.
