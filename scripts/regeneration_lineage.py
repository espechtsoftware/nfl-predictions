...
ap.add_argument("--vetted-dir", required=True); ap.add_argument("--replaced-dir", required=True); ap.add_argument("--promoted-dir", required=True)
ap.add_argument("--upload-csv"); ap.add_argument("--entries-csv"); ap.add_argument("--out", required=True)
a = ap.parse_args()
try:
    m = build_manifest(a.vetted_dir, a.replaced_dir, a.promoted_dir, upload_csv=a.upload_csv, entries_csv=a.entries_csv)
