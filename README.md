...
Other raw tables: `weekly_stats`, `snap_counts`, `depth_charts`, `rosters_weekly`, `injuries`, `schedules`, `ngs_receiving`, `ngs_rushing`, `ngs_passing`, `ftn_charting`, `player_ids`, `dk_salaries`, `dk_slates`, `odds_snapshots`.
