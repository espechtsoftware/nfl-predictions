...
The [before receipt](reviews/evidence/2026-09-19-morning-injury-join-before.json), [after receipt](reviews/evidence/2026-09-19-morning-injury-join-after.json) and [read-only checker](reviews/evidence/2026-09-19-morning-injury-join-check.py) preserve the evidence. This establishes input propagation, not a new score gain. Cache/projection completion and the final CLI proof subsequently passed in the [completed refresh](2026-09-19-morning-refresh-results.md).
