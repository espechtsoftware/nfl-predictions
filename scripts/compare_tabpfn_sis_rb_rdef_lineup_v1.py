#!/usr/bin/env python3
"""Compare conditional SIS RB run-defense same-image exact-80 books."""
...
from nfl_dfs.research import tabpfn_sis_rb_rdef_lineup_v1 as experiment  # noqa: E402
...
PREFIX = "TABPFN_SIS_RB_RDEF_STAGE_B_V1_JSON="
...
def main() -> int:
    ...
    report = {
        ...
        "mode": "pit-clean-tabpfn-sis-rb-rdef-v1",
        **audits,
