...
|---|---|---|---|
| 2026-09-19 | TabPFN upcoming context selected all labeled training rows without a target-week cutoff; repairing the 2026 salary spine adds 43 labeled current-week rows | A Week 2 refresh can include same-week labels, violating the prior-week context rule | Prepared SQL-side pre-read cutoff on `fix/2026-09-tabpfn-preweek-context`; 14 targeted tests pass. No live deployment. See [repair report](reports/2026-09-19-tabpfn-preweek-context-repair.md). |
| 2026-09-19 | DK ingest deliberately leaves raw salary week NULL for downstream schedule resolution, but salary feature SQL discarded NULL weeks before resolving them | No 2026 salary spine; all 928 Week2 inference rows lacked prior usage despite available Week1 statistics and snaps | Isolated repair on `fix/2026-09-salary-week-resolution`: actual-SQL fixtures and real-source historical parity pass; 424 players recover prior history. Full isolated feature/leakage/projection validation pending; no live adoption. See [validation report](reports/2026-09-19-salary-week-repair-validation.md). |
