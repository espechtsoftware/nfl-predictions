...
| 2026-09-05 | Historical DraftKings salary feed (lab r6 prop-availability authority built from the same DK salary files as `slate_frame`) lists 33 player-weeks across 20 of 36 slates in 2023-2024 at salaries of $200 (32 rows: 16 WR, 11 RB, 6 TE, 3 of them prop-covered) and $800 (1 row), below DraftKings' nominal $2,000 floor. First seen when the CP-1 boundary smoke (attempt cp1smoke-a1) failed closed on its frozen 2,000 salary floor at 2023-w18. | A generator treating a $200 skill player as a real DK price gets an absurd value edge; a validator with a hard floor rejects real slates. Lab CP-1 join now accepts positive integers <= 15,000, receipts sub-floor rows and requires them identical between frame and authority (branch lab/cp1-smoke-salary-domain @ 272405c). Whether $200 is a genuine DK listing (practice-squad/IR placeholder) or a feed artifact is unverified. | Open: verify against a raw DK draft-group export for one affected slate; decide accept-with-receipt vs exclude. |
