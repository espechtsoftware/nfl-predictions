...
OUT=ROOT/'2026-09-19-repaired-chain-read.json'
...
def main():
    ...
    result=dict(provenance=provenance,player_universe=dict(control=len(af),salaryfix=len(bf),common=len(common),
        ...
        reader_sha256=sha(__file__),scope='Conditional independent-bank audit of frozen generated books; no current outcomes, selection, or real NFL efficacy claim. Mixture MC errors use independent equal-weight strata.')
